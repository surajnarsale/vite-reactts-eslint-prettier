...
const User = (props: PropsWithChildren<UserProps>): JSX.Element => {
  // [PropsWithChildren] extent type with children type
  return <div className={`bg-red-200 p-5  ${props.klass}`}>{props.children}</div>;
};
